...
<template>
  <section class="space-y-3">
    ...
    <p class="text-sm text-slate-200 max-w-2xl">
      Deze pagina is bereikbaar via de route / en gebruikt Tailwind-klassen voor
      layout en typografie. In de navigatie bovenaan kun je naar het Kanban
      board gaan.
    </p>
    <div class="mt-6 p-4 rounded-lg bg-slate-900 border border-slate-800">
      ...
      <p class="text-xs text-slate-500 mt-2">
        Je kunt nu de Supabase client gebruiken in je stores en composables via
